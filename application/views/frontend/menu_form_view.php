        ...
        <form>
            <div class="tabs" id="clientInfo" >
                <div class="info-contaner">
                    ...
                    <div class="info-input-container"><div class="input-wide"><?=lang('menuform.st1.name')?></div><input name="name" type="text" /> </div>
                    <div class="info-small-container"><div class="input-small"><?=lang('menuform.st1.phone')?></div><input name="phone" type="text" /> </div>
                    <div class="info-small-container"><div class="input-small"><?=lang('menuform.st1.mobile')?></div><input name="mobile" type="text" /> </div>
                    <div class="info-input-container"><div class="input-wide"><?=lang('menuform.st1.email')?></div><input name="email" type="text" /> </div>
                    <div class="info-input-container"><div class="input-wide"><?=lang('menuform.st1.address')?></div><input name="address" type="text" /> </div>
                    <div class="info-input-container"><div class="input-wide"><?=lang('menuform.st1.salesman')?></div><input name="sales" type="text" /> </div>
            ...
            <div id="costdelivery" style="display: none;" class="tabs info-contaner">
                ...
                <div class="dilivery-input-container"><div class="input-wide"><?=lang('menuform.st9.quantity')?></div><input name="" type="text"><?=lang('menuform.st9.units')?> </div>
