...
<div>
    ...
    <span><img src="<?php $scoop->scope->get(); $scoop->scope->file->get(); echo base_url(). $scoop->scope->file->path ?>" /></span>
...
<div>
    ...
    <?php $menu->menu_shakes->get(); foreach ($menu->menu_shakes as $shake) { ?>
    <span><img src="<?php $shake->shake->get(); $shake->shake->file->get(); echo base_url(). $shake->shake->file->path ?>" /></span>
...
<div>
    ...
    <?php $menu->menu_plates->get(); foreach ($menu->menu_plates as $plate) { ?>
    <span><img src="<?php $plate->plate->get(); $plate->plate->file->get(); echo base_url(). $plate->plate->file->path ?>"  /></span>
...
<div>
    ...
    <?php $menu->type->get(); ?>
    <span><img src="<?php $menu->type->file->get(); echo base_url(). $menu->type->file->path ?>"  /></span>
...
<div>
    ...
    <?php $menu->theme->get(); ?>
    <span><img src="<?php $menu->theme->file->get(); echo base_url(). $menu->theme->file->path ?>"  /></span>
